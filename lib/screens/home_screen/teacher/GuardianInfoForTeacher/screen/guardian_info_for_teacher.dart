                          ...
                          if(detSnap.connectionState == ConnectionState.done){
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 20,),
                                GuardianInfo(icon: SvgPicture.asset(icEmail),title: detSnap.data!.docs.first["email"],onPress: (){
                                  launch(
                                      'mailto:${detSnap.data!.docs.first["email"]}');
                                },),
                                SizedBox(height: 10,),
                                GuardianInfo(icon: SvgPicture.asset(icPhone),title: detSnap.data!.docs.first["mobile"],onPress: ()async{
                                  await FlutterPhoneDirectCaller.callNumber('${detSnap.data!.docs.first["mobile"]}');
                                },),
                                SizedBox(height: 10,),
                                GuardianInfo(icon: SvgPicture.asset(icLocation),title: detSnap.data!.docs.first["address"],),
                              ],
                            );
                          }
