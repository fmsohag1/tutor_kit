      ...
      body: SafeArea(
        child: Center(
            child: FutureBuilder<QuerySnapshot>(
                future: FirebaseFirestore.instance.collection("guardianResponse").where("tEmail", isEqualTo: FirebaseAuth.instance.currentUser!.email.toString()).orderBy('timestamp',descending: true).get(),
                                ...
                                child: FadeInAnimation(
                                  ...
                                  child: FutureBuilder<DocumentSnapshot>(
                                      ...
                                      builder: (BuildContext context,AsyncSnapshot<DocumentSnapshot> detSnapshot){
                                                            ...
                                                            builder: (BuildContext context,AsyncSnapshot<QuerySnapshot> tranSnap){
                                                              ...
                                                              if(tranSnap.data!.docs.isNotEmpty){
                                                                return CustomButton(onPress: (){
                                                                  Get.to(()=>TeacherStatusScreen(postId: detSnapshot.data!.id,),arguments: detSnapshot.data!.id);
                                                                }, text: "See status", color: Colors.grey.shade600);
                                                              }
                                                              if(tranSnap.data!.docs.isEmpty){
                                                                return CustomButton(onPress: (){
                                                                  Get.to(()=>CheckoutScreen(),arguments: [detSnapshot.data!["salary"], detSnapshot.data!.id]);
                                        ...
                                        return index == 0? Center(child: CircularProgressIndicator(color: Colors.black12,strokeAlign: -1,)):SizedBox();
                                      }
                                  ),
                                ),
                              ),
